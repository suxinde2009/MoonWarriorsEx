...
bool About::init()
{
    ...
    CCLabelTTF *about = CCLabelTTF::create(" 1.This game recoded according to the logic of MoonWarriors-html5, almost all of the codes keep unanimous with the original html5 one. \n    2. This demo utilizes many features from Cocos2d-x,  including: Parallax background, tilemap, actions, ease, frame animation, schedule, Labels, keyboard Dispatcher, Scene Transition", "Arial", 18, CCSizeMake(winSize.width * 0.85, 320), kCCTextAlignmentLeft);
